...
onMounted(async () => {
    ...
    if (dialogStore.isUpdate) {
        ...
        setForm({ info: { type: PromotionType.PERCENTAGE } });
        await courseOptions;
    }
        ...
        <v-row>
            ...
            <v-col cols="6">
                <InputNumber
                    ...
                    :placeholder="
                        $t(
                            `promotionProgramme.form.placeholder.value.${formValue.info?.type}`,
                        )
                    "
                    :clearable="true"
        ...
        <v-row>
            <v-col cols="6">
                <BaseAutoComplete
                    ...
                    :placeholder="
                        $t('promotionProgramme.form.placeholder.applyForCourses')
                    "
