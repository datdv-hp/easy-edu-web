...
export default {
    ...
    permissionList: {
        ...
        lessonStudentEvaluation: 'Đánh giá học sinh trong buổi học',
        classStudentEvaluation: 'Đánh giá học sinh trong lớp hoc',
        categoryQuestion: 'Quản lý bộ câu hỏi',
        categoryExercise: 'Quản lý danh sách bài kiểm tra',
        exercise: 'Quản lý bài kiểm tra',
        tuition: 'Học phí',
    },
    permissions: {
        user: {
        ...
        schedule: {
            ...
            processLeaveRequest: 'Xử lý đơn xin nghỉ',
        ...
        classroom: {
            ...
            viewAttendance: 'Xem điểm danh học sinh',
            ...
            viewExercise: 'Xem kiểm tra',
            viewPersonalExercise: 'Xem bài kiểm tra cá nhân',
            createExercise: 'Tạo bài kiểm tra',
            deleteExercise: 'Xóa bài kiểm tra',
            addStudentToExercise: 'Thêm học sinh vào bài kiểm tra',
            removeStudentFromExercise: 'Xóa học sinh khỏi bài kiểm tra',
            detailExercise: 'Xem chi tiết bài kiểm tra',
            markScore: 'Chấm điểm',
            doExercise: 'Làm bài kiểm tra',
            detailTesting: 'Xem chi tiết bài kiểm tra',
            viewAnswerExercise: 'Xem đáp án bài kiểm tra',
        },
        lesson: {
        ...
        lessonStudentEvaluation: {
            view: 'Xem tất cả đánh giá',
            viewPersonal: 'Xem đánh giá cá nhân',
            update: 'Chỉnh sửa',
            create: 'Tạo mới',
        },
        classStudentEvaluation: {
            view: 'Xem',
            update: 'Cập nhật',
        },
        tuition: {
