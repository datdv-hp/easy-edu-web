export enum PageName {
  ...
  REGISTRATION_LIST_PAGE = 'registration_list_page',
  ...
  TEACHER_LIST_PAGE = 'teacher_list_page',
  MANAGER_LIST_PAGE = 'manager_list_page',
  USER_ACTIVE_ACCOUNT_PAGE = 'user_active_account_page',
  STUDENT_LIST_PAGE = 'student_list_page',
  TEACHER_DETAIL_PAGE = 'teacher_detail_page',
  TIMEKEEPING_PAGE = 'timekeeping_page',
  STUDENT_DETAIL_PAGE = 'student_detail_page',
  MANAGER_DETAIL_PAGE = 'manager_detail_page',
  SCHEDULE_TRACKING_PAGE = 'schedule_tracking_page',
  COURSE_LIST_PAGE = 'course_list_page',
  COURSE_DETAIL_PAGE = 'course_detail_page',
  SUBJECT_LIST_PAGE = 'subject_list_page',
  CLASSROOM_LIST_PAGE = 'classroom_list_page',
  CLASSROOM_DETAIL_PAGE = 'classroom_detail_page',
  CLASSROOM_TIMEKEEPING_PAGE = 'classroom_timekeeping_page',
  CLASSROOM_SYLLABUS_LIST_PAGE = 'classroom_syllabus_list_page',
  LESSON_LIST_PAGE = 'lesson_list_page',
  LESSON_DETAIL_PAGE = 'lesson_detail_page',
  SYLLABUS_LIST_PAGE = 'syllabus_list_page',
  SYLLABUS_DETAIL_PAGE = 'syllabus_detail_page',
  SYLLABUS_CREATE_PAGE = 'syllabus_create_page',
  SETTING_COURSE_PAGE = 'setting_course_page',
...
export const DEFAULT_LIMIT_FOR_PAGINATION = 20;
